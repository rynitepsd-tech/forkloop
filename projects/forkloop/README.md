...
| Teacher policy (Anthropic computer-use toolset) and student policy (vLLM, Fara/Qwen/UI-TARS output formats) | teacher **verified live**: 8/12 family-3 episodes at reward 1.0, 12 seeds (`docs/spikes.md`); student not run against a live endpoint |
